...
const contact = () => {
  return (
    <div className='  mb-[537px]' id='contact'>
      <div className='flex flex-col items-center'> 
        ...
        <div className='lg:flex lg:flex-row md:grid mg:grid-cols-1 gap-[273px] mt-[109px]  justify-center'>
          ...
          <form
              ...
              >
                <div className=' flex flex-col gap-1 w-full p-[32px]'>
                    ...
                    <input
                      className=' customborder rounded-[5.333px] h-[52px]  mb-[32px] flex bg-transparent p-6 '
                      type='text'
                      name='name'
                    />
                  ...
                  <button className=' text-gray-100  w-screen gradient-button h-[63px]'>
                    Send Message
                  </button>
